...
import ProfieDropdown from "../layout/ProfieDropdown";
...
const Header = () => {
  ...
  const user = { name: "Faique", email: "faique1202@gmail.com" };
  const logout = () => {};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-[#670229] rounded-md flex items-center justify-center">
              <FileText className="text-white w-4 h-4" />
            </div>
            <span className="text-xl font-bold text-gray-900">Bill Craft</span>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className="bg-[#670229] hover:bg-[#850335] px-6 py-2.5 text-white rounded-lg font-medium transition-all duration-200"
                >
                  SignUp
                </Link>
              </>
