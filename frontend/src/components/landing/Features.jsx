    ...
    <section id="features" className="py-20 lg:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">Powerful features to run you business</h2>
                <p className="text-xl text-gray-600 mx-w-3xl mx-auto">Everything you need to manage your invoicing and get paid.</p>
            </div>
